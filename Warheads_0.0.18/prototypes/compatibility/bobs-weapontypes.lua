...
weaponTypes["rounds-magazine"].extra_ingredients = {
  {type="item", name="bullet-casing", amount=5},
...
weaponTypes["shotgun-shell"].extra_ingredients = {{type="item", name="cordite", amount=1}}
...
weaponTypes["shotgun-shell-slug"].extra_ingredients = {{type="item", name="cordite", amount=1}}
...
weaponTypes["shotgun-shell-buckshot"].extra_ingredients = {{type="item", name="cordite", amount=1}}
...
weaponTypes["shotgun-shell-birdshot"].extra_ingredients = {{type="item", name="cordite", amount=1}}
