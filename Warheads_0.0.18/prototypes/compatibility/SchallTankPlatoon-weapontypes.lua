weaponTypes["Schall-sniper-magazine"]= {
  ...
  addon_icon = {icon = "__SchallTankPlatoon__/graphics/icons/sniper-bullet.png", icon_size = 128},
  energy_required = 1,
  warhead_count = 10,
...
weaponTypes["cannon-shell-88"]= {
  ...
  addon_icon = {icon = "__SchallTankPlatoon__/graphics/icons/H1.png", icon_size = 128},
  energy_required = 1,
  range_modifier = 3,
...
weaponTypes["cannon-shell-128"]= {
  ...
  icon = "__base__/graphics/icons/cannon-shell.png",
  addon_icon = {icon = "__SchallTankPlatoon__/graphics/icons/H2.png", icon_size = 128},
  energy_required = 1,
  range_modifier = 3,
  appearance_fallback = "cannon-shell",
  icons = {},
