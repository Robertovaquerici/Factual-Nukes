...
if(nuke_materials.smallBoomMaterial == "californium") then
  data:extend({
    ...
    },
    {
      ...
      ingredients = {{type="item", name=nuke_materials.boomMaterial, amount=10}, {type="item", name=nuke_materials.deadMaterial, amount=1}},
      icon = "__True-Nukes__/graphics/californium-processing.png",
      icon_size = 64,      subgroup = "intermediate-product",
      order = "r[uranium-processing]-da[californium-processing]",
      main_product = "",
      results = {{type="item", name=nuke_materials.boomMaterial, amount=9}, {type="item", name="californium", amount=1}},
    ...
    },
    {
      ...
      enabled = false,
      category = "centrifuging",
      ingredients = {{type="item", name=nuke_materials.boomMaterial, amount=5}, {type="item", name=nuke_materials.reflector, amount=2}},
      icons = {
        {icon = "__True-Nukes__/graphics/californium-processing.png", icon_size = 64},
      ...
      main_product = "",
      results = {{type="item", name=nuke_materials.boomMaterial, amount=4}, {type="item", name=nuke_materials.deadMaterial, amount=1}, {type="item", name=nuke_materials.reflector, amount=1}, {type="item", name = nuke_materials.reflector, amount = 1, probability = 0.6}, {type="item", name="californium", amount=1}},
      allow_decomposition = false
    },
  });
end
...
data:extend{
  {
    ...
    enabled = false,
    category = "centrifuging",
    ingredients = {{type="item", name="uranium-235", amount=20}, {type="item", name="uranium-238", amount=5}, {type="item", name=nuke_materials.reflector, amount=2}},
    icons = {
      {icon = "__base__/graphics/icons/kovarex-enrichment-process.png", icon_size = 64},
      {icon = "__True-Nukes__/graphics/plus-red.png", icon_size = 32, scale = 0.333, shift = {10, -10}}
    },
    subgroup = "intermediate-product",
    order = "r[uranium-processing]-cc[kovarex-enrichment-process]",
    main_product = "",
    results = {{type="item", name="uranium-235", amount=21}, {type="item", name="uranium-238", amount=2}, {type="item", name=nuke_materials.reflector, amount=1}, {type="item", name = nuke_materials.reflector, amount = 1, probability = 0.6}},
    allow_decomposition = false
  },
  {
    type = "item",
...
if(nuke_materials.fusionMaterial == "tritium-canister") then
  data:extend({
    ...
    },
    {
      ...
      icons = {
        {icon = "__True-Nukes__/graphics/tritium-breeder-fuel-cell.png", icon_size = 64},
        {icon = "__True-Nukes__/graphics/plus-red.png", icon_size = 32, scale = 0.333, shift = {10, -10}}
      },
      pictures =
      {
    ...
    },
    {
      ...
      icons = {
        {icon = "__True-Nukes__/graphics/used-up-tritium-breeder-fuel-cell.png", icon_size = 64},
        {icon = "__True-Nukes__/graphics/plus-red.png", icon_size = 32, scale = 0.333, shift = {10, -10}}
      },
      subgroup = "intermediate-product",
...

    {
      ...
      enabled = false,
      category = "centrifuging",
      ingredients = {{type="item", name="used-up-tritium-breeder-fuel-cell", amount=5}, {type="item", name="plastic-bar", amount=5}},
      icon = "__True-Nukes__/graphics/tritium-extraction.png",
      icon_size = 64,      subgroup = "intermediate-product",
      order = "r[uranium-processing]-cj[tritium-extraction]",
      main_product = "",
      results = {{type="item", name="tritium-canister", amount=1}, {type="item", name="uranium-238", amount=3}},
      allow_decomposition = false
    },

    {
      ...
      enabled = false,
      category = "centrifuging",
      ingredients = {{type="item", name="used-up-advanced-tritium-breeder-fuel-cell", amount=2}, {type="item", name="plastic-bar", amount=5}},
      icons = {
        {icon = "__True-Nukes__/graphics/tritium-extraction.png", icon_size = 64},
        {icon = "__True-Nukes__/graphics/plus-red.png", icon_size = 32, scale = 0.333, shift = {10, -10}}
      },
      subgroup = "intermediate-product",
      order = "r[uranium-processing]-cm[tritium-extraction]",
      main_product = "",
      results = {{type="item", name="tritium-canister", amount=1}, {type="item", name="uranium-238", amount=2}, {type="item", name = nuke_materials.reflector, amount = 1, probability = 0.8}},
      allow_decomposition = false
    },
    {
      type = "recipe",
      ...
      results = {{type="item", name="advanced-tritium-breeder-fuel-cell", amount=10}}
    },
    {
      type = "recipe",
      name = "tritium-breeder-fuel-cell",
      ...
      category = "crafting-with-fluid",
      ingredients = table.deepcopy(data.raw.recipe["uranium-fuel-cell"].ingredients),
      results = {{type="item", name="tritium-breeder-fuel-cell", amount=10}}
    },
    {
      type = "item",
